...
//			int planes, int bitsPerPixel, int imageSize, int xPelsPerMeter, int yPelsPerMeter, int clrUsed, int clrImportant, byte[] codecHeader)
	...
	public void testMatches()
	{
		...
		assertTrue(	new AviVideoFormat("xyz", new Dimension(1, 2), 2000, Format.byteArray, 2.f, 1, 2, 3, 4, 5, 6, 7, codecHeader).matches(
					new AviVideoFormat("xyz", new Dimension(1, 2), 2000, Format.byteArray, 2.f, 1, 2, 3, 4, 5, 6, 7, codecHeader)));

		assertFalse(	new AviVideoFormat("xyz", new Dimension(1, 2), 2000, Format.byteArray, 2.f, 1, 2, 3, 4, 5, 6, 7, codecHeader).matches(
