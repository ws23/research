...
public class ConcreteClasses
{
	public static final Class[] ALL = new Class[] {
	    ...
	    javax.media.CaptureDeviceInfo.class, // (implements java.io.Serializable)
	    javax.media.CaptureDeviceManager.class,
	    //java.awt.Component.class, // (implements java.awt.image.ImageObserver.class, java.awt.MenuContainer.class, java.io.Serializable)
	          //java.awt.Container.class,
	                javax.media.bean.playerbean.MediaPlayer.class, // (implements java.io.Externalizable.class, javax.media.Player)
	                //java.awt.Panel.class,
	                      javax.media.bean.playerbean.MediaPlayerMediaLocationEditor.class, // (implements java.awt.event.ActionListener.class, java.awt.event.ItemListener.class, java.beans.PropertyEditor) 
	                //java.awt.Window.class,
	                      //java.awt.Dialog.class,
	                            javax.media.bean.playerbean.MediaPlayerRTPDialog.class,
	    javax.media.ControllerAdapter.class, // (implements javax.media.ControllerListener.class, java.util.EventListener)
	    javax.media.protocol.DataSource.class, // (implements javax.media.protocol.Controls.class, javax.media.Duration)
	          ...
	          javax.media.protocol.PushDataSource.class,
	                javax.media.rtp.RTPPushDataSource.class,
	                      javax.media.rtp.RTPSocket.class, // (implements javax.media.rtp.DataChannel) 
	    javax.media.rtp.EncryptionInfo.class, // (implements java.io.Serializable)
	   // java.util.EventObject.class, // (implements java.io.Serializable)
	    ...
	    javax.media.Format.class, // (implements java.lang.Cloneable.class, java.io.Serializable)
	    ...
	    javax.media.protocol.InputSourceStream.class, // (implements javax.media.protocol.PullSourceStream)
	    ...
	    //java.beans.PropertyEditorSupport.class, // (implements java.beans.PropertyEditor)
	          javax.media.bean.playerbean.MediaPlayerVolumePropertyEditor.class,
	    javax.media.protocol.RateRange.class, // (implements java.io.Serializable)
	    ...
	    javax.media.rtp.RTPHeader.class, // (implements java.io.Serializable)
	    javax.media.rtp.RTPManager.class, // (implements javax.media.Controls)
	    javax.media.rtp.SessionAddress.class, // (implements java.io.Serializable)
	    //java.beans.SimpleBeanInfo.class, // (implements java.beans.BeanInfo)
	          javax.media.bean.playerbean.MediaPlayerBeanInfo.class,
	    javax.media.rtp.rtcp.SourceDescription.class, // (implements java.io.Serializable)
	    javax.media.SystemTimeBase.class, // (implements javax.media.TimeBase)
	    //java.lang.Throwable.class, // (implements java.io.Serializable)
	         ...
	         // java.lang.Exception.class,
	                ...
	                javax.media.rtp.SessionManagerException.class,
	                      ...
	                      javax.media.rtp.SSRCInUseException.class,
	    javax.media.Time.class, // (implements java.io.Serializable) 
