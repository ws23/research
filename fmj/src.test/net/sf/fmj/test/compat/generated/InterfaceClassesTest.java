...
public class InterfaceClassesTest extends TestCase
{
	public void test_javax_media_Effect() throws Exception
	{
		...
		// Static fields:
		assertTrue(javax.media.Effect.BUFFER_PROCESSED_OK == 0);
		assertTrue(javax.media.Effect.BUFFER_PROCESSED_FAILED == 1);
		assertTrue(javax.media.Effect.INPUT_BUFFER_NOT_CONSUMED == 2);
		assertTrue(javax.media.Effect.OUTPUT_BUFFER_NOT_FILLED == 4);
		assertTrue(javax.media.Effect.PLUGIN_TERMINATED == 8);
	...
	public void test_javax_media_rtp_SendStream() throws Exception
	{
		...
		if (false)
		{
			...
			o.setBitRate(0);
			o
					.setSourceDescription((javax.media.rtp.rtcp.SourceDescription[]) null);
	...
	public void test_javax_media_control_FrameGrabbingControl()
			throws Exception
	{
		assertEquals(javax.media.control.FrameGrabbingControl.class
				.getModifiers(), 1537);
	...
	{
		assertEquals(javax.media.rtp.GlobalTransmissionStats.class
				.getModifiers(), 1537);
	...
	public void test_javax_media_protocol_PullSourceStream() throws Exception
	{
		...
		// Static fields:
		assertTrue(javax.media.protocol.PullSourceStream.LENGTH_UNKNOWN == -1L);
	...
	{
		assertEquals(javax.media.control.StreamWriterControl.class
				.getModifiers(), 1537);
	...
	public void test_javax_media_DataSink() throws Exception
	{
		...
		if (false)
		{
			...
			o
					.removeDataSinkListener((javax.media.datasink.DataSinkListener) null);
			o.setSource((javax.media.protocol.DataSource) null);
			o.getControls();
			o.getControl((java.lang.String) null);
		}
	...
	public void test_javax_media_ExtendedCachingControl() throws Exception
	{
		...
		// Static fields:
		assertTrue(javax.media.ExtendedCachingControl.LENGTH_UNKNOWN == 9223372036854775807L);
		...
		if (false)
		{
			...
			o
					.removeDownloadProgressListener((javax.media.DownloadProgressListener) null);
			o.getContentLength();
			o.getControlComponent();
			o.isDownloading();
	...
	public void test_javax_media_rtp_SessionManager() throws Exception
	{
		...
		if (false)
		{
			...
			o
					.addReceiveStreamListener((javax.media.rtp.ReceiveStreamListener) null);
			...
			o
					.removeReceiveStreamListener((javax.media.rtp.ReceiveStreamListener) null);
			o
					.removeSendStreamListener((javax.media.rtp.SendStreamListener) null);
			o.getDefaultSSRC();
	...
	public void test_javax_media_protocol_PushSourceStream() throws Exception
	{
		...
		// Static fields:
		assertTrue(javax.media.protocol.PushSourceStream.LENGTH_UNKNOWN == -1L);
		...
		if (false)
		{
			...
			o.read((byte[]) null, 0, 0);
			o
					.setTransferHandler((javax.media.protocol.SourceTransferHandler) null);
	...
	public void test_javax_media_Processor() throws Exception
	{
		...
		assertTrue(javax.media.Processor.Unrealized == 100);
		assertTrue(javax.media.Processor.Realizing == 200);
		assertTrue(javax.media.Processor.Realized == 300);
		assertTrue(javax.media.Processor.Prefetching == 400);
		assertTrue(javax.media.Processor.Prefetched == 500);
		assertTrue(javax.media.Processor.Started == 600);
		...
		if (false)
		{
			...
			o
					.setContentDescriptor((javax.media.protocol.ContentDescriptor) null);
			o.getContentDescriptor();
			o.getDataOutput();
			o.start();
	...
	public void test_javax_media_Demultiplexer() throws Exception
	{
		...
		assertTrue(javax.media.Duration.class
				.isAssignableFrom(javax.media.Demultiplexer.class));
		// Static fields:
		assertTrue(javax.media.Demultiplexer.BUFFER_PROCESSED_OK == 0);
		assertTrue(javax.media.Demultiplexer.BUFFER_PROCESSED_FAILED == 1);
		assertTrue(javax.media.Demultiplexer.INPUT_BUFFER_NOT_CONSUMED == 2);
		assertTrue(javax.media.Demultiplexer.OUTPUT_BUFFER_NOT_FILLED == 4);
		assertTrue(javax.media.Demultiplexer.PLUGIN_TERMINATED == 8);
		// TODO: test DURATION_UNBOUNDED of type javax.media.Time
		// TODO: test DURATION_UNKNOWN of type javax.media.Time
	...
	public void test_javax_media_Player() throws Exception
	{
		...
		// Static fields:
		// TODO: test LATENCY_UNKNOWN of type javax.media.Time
		assertTrue(javax.media.Player.Unrealized == 100);
		assertTrue(javax.media.Player.Realizing == 200);
		assertTrue(javax.media.Player.Realized == 300);
		assertTrue(javax.media.Player.Prefetching == 400);
		assertTrue(javax.media.Player.Prefetched == 500);
		assertTrue(javax.media.Player.Started == 600);
		// TODO: test RESET of type javax.media.Time
		// TODO: test DURATION_UNBOUNDED of type javax.media.Time
		// TODO: test DURATION_UNKNOWN of type javax.media.Time
	...
	{
		assertEquals(javax.media.protocol.RateConfigureable.class
				.getModifiers(), 1537);
		...
		if (false)
		{
			...
			o
					.setRateConfiguration((javax.media.protocol.RateConfiguration) null);
		}
	}
	...
	public void test_javax_media_control_FrameProcessingControl()
			throws Exception
	{
		assertEquals(javax.media.control.FrameProcessingControl.class
				.getModifiers(), 1537);
	...
	public void test_javax_media_control_SilenceSuppressionControl()
			throws Exception
	{
		assertEquals(javax.media.control.SilenceSuppressionControl.class
				.getModifiers(), 1537);
	...
	public void test_javax_media_renderer_VideoRenderer() throws Exception
	{
		...
		// Static fields:
		assertTrue(javax.media.renderer.VideoRenderer.BUFFER_PROCESSED_OK == 0);
		assertTrue(javax.media.renderer.VideoRenderer.BUFFER_PROCESSED_FAILED == 1);
		assertTrue(javax.media.renderer.VideoRenderer.INPUT_BUFFER_NOT_CONSUMED == 2);
		assertTrue(javax.media.renderer.VideoRenderer.OUTPUT_BUFFER_NOT_FILLED == 4);
		assertTrue(javax.media.renderer.VideoRenderer.PLUGIN_TERMINATED == 8);
	...
	public void test_javax_media_protocol_PullBufferStream() throws Exception
	{
		...
		// Static fields:
		assertTrue(javax.media.protocol.PullBufferStream.LENGTH_UNKNOWN == -1L);
	...
	public void test_javax_media_protocol_SourceTransferHandler()
			throws Exception
	{
		assertEquals(javax.media.protocol.SourceTransferHandler.class
				.getModifiers(), 1537);
	...
	public void test_javax_media_Multiplexer() throws Exception
	{
		...
		// Static fields:
		assertTrue(javax.media.Multiplexer.BUFFER_PROCESSED_OK == 0);
		assertTrue(javax.media.Multiplexer.BUFFER_PROCESSED_FAILED == 1);
		assertTrue(javax.media.Multiplexer.INPUT_BUFFER_NOT_CONSUMED == 2);
		assertTrue(javax.media.Multiplexer.OUTPUT_BUFFER_NOT_FILLED == 4);
		assertTrue(javax.media.Multiplexer.PLUGIN_TERMINATED == 8);
	...
	{
		assertEquals(javax.media.protocol.RateConfiguration.class
				.getModifiers(), 1537);
	...
	public void test_javax_media_protocol_BufferTransferHandler()
			throws Exception
	{
		assertEquals(javax.media.protocol.BufferTransferHandler.class
				.getModifiers(), 1537);
	...
	public void test_javax_media_protocol_PushBufferStream() throws Exception
	{
		...
		// Static fields:
		assertTrue(javax.media.protocol.PushBufferStream.LENGTH_UNKNOWN == -1L);
		...
		if (false)
		{
			...
			o.getFormat();
			o
					.setTransferHandler((javax.media.protocol.BufferTransferHandler) null);
			o.getContentLength();
			o.getContentDescriptor();
			o.endOfStream();
			o.getControls();
	...
	public void test_javax_media_Renderer() throws Exception
	{
		...
		// Static fields:
		assertTrue(javax.media.Renderer.BUFFER_PROCESSED_OK == 0);
		assertTrue(javax.media.Renderer.BUFFER_PROCESSED_FAILED == 1);
		assertTrue(javax.media.Renderer.INPUT_BUFFER_NOT_CONSUMED == 2);
		assertTrue(javax.media.Renderer.OUTPUT_BUFFER_NOT_FILLED == 4);
		assertTrue(javax.media.Renderer.PLUGIN_TERMINATED == 8);
	...
	public void test_javax_media_control_FramePositioningControl()
			throws Exception
	{
		assertEquals(javax.media.control.FramePositioningControl.class
				.getModifiers(), 1537);
	...
	public void test_javax_media_Codec() throws Exception
	{
		...
		// Static fields:
		assertTrue(javax.media.Codec.BUFFER_PROCESSED_OK == 0);
		assertTrue(javax.media.Codec.BUFFER_PROCESSED_FAILED == 1);
		assertTrue(javax.media.Codec.INPUT_BUFFER_NOT_CONSUMED == 2);
		assertTrue(javax.media.Codec.OUTPUT_BUFFER_NOT_FILLED == 4);
		assertTrue(javax.media.Codec.PLUGIN_TERMINATED == 8);
