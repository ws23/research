	...
	public static final Class[] ALL = new Class[] {
		    ...
		    javax.media.Control.class, 
		          ...
		          javax.media.control.FormatControl.class, 
		                javax.media.control.TrackControl.class, //(also extends javax.media.Controls) 
		    ...
		    javax.media.Controls.class, 
		          ...
		          javax.media.DataSink.class, //(also extends javax.media.MediaHandler)
		          javax.media.PlugIn.class, 
		                javax.media.Codec.class, 
		                      javax.media.Effect.class, 
		                javax.media.Demultiplexer.class, //(also extends javax.media.Duration, javax.media.MediaHandler)
		          ...
		          javax.media.control.TrackControl.class, //(also extends javax.media.control.FormatControl) 
		    ...
		    javax.media.Duration.class, 
		          javax.media.Controller.class, //(also extends javax.media.Clock)
		                javax.media.Player.class, //(also extends javax.media.MediaHandler)
		                      javax.media.Processor.class, 
		          javax.media.Demultiplexer.class, //(also extends javax.media.MediaHandler, javax.media.PlugIn)
		   ...
		   // java.util.EventListener.class, 
		    ...
		    javax.media.MediaHandler.class, 
		          ...
		          javax.media.Demultiplexer.class, //(also extends javax.media.Duration, javax.media.PlugIn)
		    ...
		    javax.media.TimeBase.class, 
		    javax.media.TrackListener.class, 
