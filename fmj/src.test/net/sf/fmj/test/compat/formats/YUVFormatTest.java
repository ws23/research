...
public class YUVFormatTest extends TestCase
{
	...
	public void testToString()
	{
		...
		assertEquals(new YUVFormat(new Dimension(1, 2), 1, int[].class, 2.f, 4, 5, 6, 7, 8, 9).toString(), "YUV Video Format: Size = java.awt.Dimension[width=1,height=2] MaxDataLength = 1 DataType = class [I yuvType = 4 StrideY = 5 StrideUV = 6 OffsetY = 7 OffsetU = 8 OffsetV = 9\n");
