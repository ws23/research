...
public class FormatPrivateTest extends TestCase
{
	...
	public void testAudioFormat() throws Exception
	{
...

		{
			...
			f.setAccessible(true);
			assertEquals((Double) f.get(format), new Double(-1.0));
		}
	...
	public static long getEncodingCode(Format value, String s) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException
	{
		final Method m = Format.class.getDeclaredMethod("getEncodingCode", new Class[]{String.class});
		m.setAccessible(true);
		final Long result = (Long) m.invoke(value, new Object[] {s});
		return result.longValue();
	}
	
	public static long getEncodingCode(Format value) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException
	{
	...
	private static Class getClz(Format value) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException
	{
