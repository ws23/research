...
//				}
	...
	private void checkEncodingCode(Format f1) throws SecurityException, IllegalArgumentException, NoSuchFieldException, IllegalAccessException
	{
//		{
//			if (FormatPrivateTest.getEncodingCode(f1) != 0)
//			{
//				System.out.println("SHOULD BE ZERO: " + MediaCGUtils.formatToStr(f1));
//			}
...
//		String s = f1.toString();
		...
		
		{
			if (FormatPrivateTest.getEncodingCode(f1) != 0)
			{
				System.out.println("assertEquals(FormatPrivateTest.getEncodingCode(" +  MediaCGUtils.formatToStr(f1) + "), " + CGUtils.toLiteral(FormatPrivateTest.getEncodingCode(f1)) + ");");
	
			}
			else
			{
				System.out.println("ZERO(FormatPrivateTest.getEncodingCode(" +  MediaCGUtils.formatToStr(f1) + "), " + CGUtils.toLiteral(FormatPrivateTest.getEncodingCode(f1)) + ");");
