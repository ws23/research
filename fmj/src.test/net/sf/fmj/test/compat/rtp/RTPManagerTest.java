...
public class RTPManagerTest extends TestCase
{
	...
	{
		synchronized (PackageManager.class) // to prevent conflicts with other tests that modify the package manager
		{
			{
				Vector v = javax.media.rtp.RTPManager.getRTPManagerList();
				//dumpStringVector(v);
				assertStringVectorEquals(javax.media.rtp.RTPManager.getRTPManagerList(), new String[] {"media.rtp.RTPSessionMgr", "javax.media.rtp.RTPSessionMgr", "com.sun.media.rtp.RTPSessionMgr", "com.ibm.media.rtp.RTPSessionMgr"});
			}
			// show that getRTPManagerList is not using the content prefix list:
			{
				...
				assertStringVectorEquals(PackageManager.getContentPrefixList(), new String[] {"javax", "com.ibm"});
			...
			// show that getRTPManagerList is using the protocol prefix list:
			{
				...
				assertStringVectorEquals(PackageManager.getProtocolPrefixList(), new String[] {"javax", "com.ibm"});
				
				//dumpStringVector(PackageManager.getProtocolPrefixList());
				//dumpStringVector(javax.media.rtp.RTPManager.getRTPManagerList());
				assertStringVectorEquals(javax.media.rtp.RTPManager.getRTPManagerList(), new String[] {"media.rtp.RTPSessionMgr", "javax.media.rtp.RTPSessionMgr", "com.ibm.media.rtp.RTPSessionMgr"});
			}
		}
	}
